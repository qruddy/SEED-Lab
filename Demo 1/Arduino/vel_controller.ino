...
double rho_Kp = 0.0; //Proportional Gain of the PI controller, in units of [volts/radian]
double rho_Ki = 33.5; //Integral Gain of the PI controller, in units of [volts*seconds/radian]

//angle controller variables
double phi = 0;
double phi_error = 0.0;
double phi_integral = 0.0;
double phi_Kp = 0; //matlab simulation gives Kp = 0.362
double phi_Ki = 0; //matlab simulation gives Ki = 11.489 ~ 11.5
...
//---------------------------------velocity ctrl------------------------------------------
  Serial.println("rho_d: " + (String)rho_d);
  ...
  Serial.println("rho_error = " + (String)rho_error);
...
//------------------------------angle ctrl------------------------------------------
  ...
  phi_integral = phi_error*(.005)+rho_integral; //integral calculation uses 5 ms as time between each iteration
